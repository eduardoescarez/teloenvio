...
class Pedidos(models.Model):                
    ...
    id_estado = models.ForeignKey(Estado_Pedido, on_delete=models.DO_NOTHING, null=True, blank=True)
    id_productor = models.ForeignKey(Productores, on_delete=models.DO_NOTHING, null=True, blank=True)
    # id_cliente = models.ForeignKey(Clientes, on_delete=models.DO_NOTHING, null=True, blank=True)
    nombre_cliente = models.CharField(max_length=40, null=True, blank=True)
    direccion_cliente = models.CharField(max_length=50, null=True, blank=True)
    comuna_cliente = models.CharField(max_length=30, null=True, blank=True)
    telefono_cliente = models.CharField(max_length=12, null=True, blank=True)
    email_cliente = models.EmailField(max_length=40, null=True, blank=True)
